...
<div class="box-container">
 <form action="{{route("add")}}" class="ajoute-form" method="POST" enctype="multipart/form-data">
    ...
    <div><label>Nom et prenom :</label><input type="text" name="nom_client"/></div>
    <div><label>Numero de cin :</label><input type="text" name="numero_cin"/></div>
    ...
    <div><label>CIN :</label><input type="file" name="cin" accept="application/pdf,application/vnd.ms-excel" class="file-input"  /></div>
